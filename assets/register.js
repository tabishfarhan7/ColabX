...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById('userType').addEventListener('change', function () {
        ...
        document.getElementById('govtField').style.display = (userType === 'govt') ? 'flex' : 'none';
        document.getElementById('entrepreneurFields').style.display = (userType === 'entrepreneur') ? 'flex' : 'none';
        document.getElementById('businessField').style.display = (userType === 'entrepreneur') ? 'flex' : 'none';
    });
